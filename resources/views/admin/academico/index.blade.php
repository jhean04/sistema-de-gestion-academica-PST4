        ...
        <div class="card card-outline card-primary shadow">
            <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="academicTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="anios-tab" data-toggle="pill" href="#anios" role="tab" aria-controls="anios" aria-selected="true">
                            <i class="fas fa-calendar-alt"></i> Ciclos Lectivos
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="grados-tab" data-toggle="pill" href="#grados" role="tab" aria-controls="grados" aria-selected="false">
                            <i class="fas fa-layer-group"></i> Grados y Secciones
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="periodos-tab" data-toggle="pill" href="#periodos" role="tab" aria-controls="periodos" aria-selected="false">
            ...
            <div class="card-body">
                <div class="tab-content" id="academicTabContent">
                    ...
                    {{-- TAB 3: PERIODOS --}}
                    <div class="tab-pane fade" id="periodos" role="tabpanel" aria-labelledby="periodos-tab">
                        <div class="text-right mb-3">
